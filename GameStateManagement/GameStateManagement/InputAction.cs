...
namespace GameStateManagement
{
    ...
    /// the buttons/keys are pressed or whether the action should occur each frame.
    /// 
    ...
    public class InputAction
    {
        ...
        // These delegate types map to the method on InputState. We use these to simplify the evaluate method
